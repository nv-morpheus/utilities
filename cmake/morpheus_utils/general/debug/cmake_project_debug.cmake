...
function(morpheus_utils_print_config)
    ...
    message(STATUS "CMAKE_FIND_USE_INSTALL_PREFIX: " ${CMAKE_FIND_USE_INSTALL_PREFIX})
    ...
    message(STATUS "ENV{CMAKE_INCLUDE_PATH}: " $ENV{CMAKE_INCLUDE_PATH})
    message(STATUS "ENV{CMAKE_LIBRARY_PATH}: " $ENV{CMAKE_LIBRARY_PATH})
