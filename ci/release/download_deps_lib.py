...
def parse_args(*, default_conda_yaml: str,
               default_conda_json: str) -> argparse.Namespace:
    ...
    argparser.add_argument(
        ...
        help=
        ("JSON formatted output of the resolved Conda environment. Generated by running: "
         "`./docker/run_container_release.sh conda list --json > .tmp/container_pkgs.json` "
